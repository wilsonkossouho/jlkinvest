...
class ProspectsController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = public_path('json/contries.json');
        $data = file_get_contents($data);
        $contries = json_decode($data);
        $indicatiftelephone1=[];
        $indicatiftelephone2=[];


        $telephone1 =(explode(" ", $dataTypeContent['telephone1']));
        $indicatiftelephone1 = $telephone1[0];
        $dataTypeContent['telephone1'] = (explode(" ", $dataTypeContent['telephone1']))[1];

        $telephone2 = (explode(" ", $dataTypeContent['telephone2']));
        $indicatiftelephone2 = $telephone2[0];
        if(empty($indicatiftelephone2))
            array_push($telephone2,"");
        $dataTypeContent['telephone2'] = $telephone2[1];

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','contries','indicatiftelephone1','indicatiftelephone2'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            $request['telephone1'] = '+'.$request['indicatiftelephone1'].' '.$request['telephone1'];
        }
        if(!empty($request['telephone2']))
        {
            $request['telephone2'] = '+'.$request['indicatiftelephone2'].' '.$request['telephone2'];
        }
